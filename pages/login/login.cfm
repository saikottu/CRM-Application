<cfif structKeyExists(form, "username") AND structKeyExists(form, "password")>
    ...
    <cfif myquery.recordcount EQ 1>
        ...
        <cflocation url="../../pages/home Page/home.cfm">
    <cfelse>
  ...
  <p class="success-msg">Successfully Logout!</p>
    ...
    <div class="login-container">
        ...
        <form method="post">
         ...
         <form action="../../pages/registration/register.cfm" method="get">
    <input class="reg-btn" type="submit" value="Registration">
  </form></br>
  <a href="../../pages/forgot password/forgot.cfm">forgot password?</a>
    </div>
</body>
</html>
