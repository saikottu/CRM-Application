...
<cfelse>
    ...
    <cfif getRequests.recordCount EQ 0>
        ...
        <cflocation url="request_report.cfm">
    </cfif>
...
<link rel="stylesheet" href="request_report.css">
    ...
    <div class="request-content">
        <cfoutput>
          <div class="home-btn">
            ...
            <div class="home-btn"><a href="request_report.cfm?download=true&department=#URLEncodedFormat(url.department)#" class="download-link">DOWNLOAD HERE</a></div>
        </cfoutput>

        <div class="home-btn">
            <a href="../../../pages/requests/view_requests/view_requests.cfm" class="home-link">Back to View Requests</a>
        </div>
    </div>
</div>
</cfif>